...
{kaap-short} offers the same features as the Helm chart, but with Pulsar components like brokers and bookies registered as custom resources.
The {kaap-operator} can then automatically scale Pulsar pods based on specifications you set in the Helm chart, and adjust according to your cluster's workload.

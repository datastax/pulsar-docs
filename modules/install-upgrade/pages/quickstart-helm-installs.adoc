...
* Depending on the cloud provider, the latest 'Storage Driver' should be used, along with the fastest disk type, such as GP3 in AWS

* Five {zookeeper-reg} replicas

* Three {bookkeeper-reg} bookies
...
Now open a browser to \http://localhost:8080. In the {pulsar-short} Admin Console, you can test your {pulsar-short} setup using the built-in clients (Test Clients in the left-hand menu).

...
If you enable {pulsar-short} SQL, the cluster provides https://trino.io/[Trino] access to the data stored in BookKeeper (and tiered storage, if enabled). Trino is exposed on the service named `<release>-sql`.

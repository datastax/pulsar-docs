...
* https://github.com/apache/pulsar/pull/16581[#16581 - Rename {pulsar-short} txn metrics to specify OpenMetrics]
* https://github.com/apache/pulsar/pull/16610[#16610 - Rename {pulsar-short} schema metrics to specify OpenMetrics]
* https://github.com/apache/pulsar/pull/16611[#16611 - Rename {pulsar-short} lb metrics to specify OpenMetrics]
...
The Helm chart for {product} is available in the https://github.com/datastax/pulsar-helm-chart/blob/master/helm-chart-sources/pulsar/values.yaml[Helm chart sources] repository.

...
**Downgrading to {product} 2.10 from {product} 3.1 is not supported for Bookies and ZooKeeper**.
...
Upgrade to {product} 3.1 on Kubernetes with the KAAP (Kubernetes Autoscaling for {pulsar}) operator.

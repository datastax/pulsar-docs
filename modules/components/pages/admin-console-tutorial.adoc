...
Go to the Pulsar Admin Console's **Test Clients** page.
...
This action creates a connection from the Pulsar Admin Console that's running in your browser to the Pulsar instance on your server.
...
For more on building and running a standalone Pulsar Admin console, see the xref:admin-console-vm.adoc[Admin Console on Server/VM] or the https://github.com/datastax/pulsar-admin-console#dev[Pulsar Admin console README].
...
The {pulsar-beam-repo}[{pulsar-short} Beam] project is an HTTP-based streaming and queueing system for use with {pulsar}.
...
In this guide, you'll install a minimal {company} {pulsar-short} Helm chart that includes {pulsar-short} Beam.
...
You have now completed the basics of using Beam in a {pulsar-short} Cluster. Refer to the project's {pulsar-beam-repo}/blob/master/README.md[readme] to see all the possibilities!
...
* {pulsar-beam-repo}[Learn more] about the {pulsar-short} Beam project
* https://kafkaesque-io.github.io/pulsar-beam-swagger[{pulsar-short} Beam API]

...
The minimalist Helm chart values use the https://github.com/datastax/release-notes/blob/master/Luna_Streaming_3.1_Release_Notes.md#lunastreaming-all-distribution[datastax/lunastreaming-all] image, which includes all supported Pulsar connectors.

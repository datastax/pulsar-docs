...
A function that is already running can be updated with a new configuration.
...
If the function has an output topic and the function returns data to the output topic, it is printed.

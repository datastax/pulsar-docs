...
To configure, deploy, and use the DataStax enhanced Cassandra sink connector, see the xref:pulsar-connector:ROOT:index.adoc[DataStax Apache Pulsar Connector documentation].

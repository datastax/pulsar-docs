...
{"access_token":"ey...CE2ug","expires_in":600,"refresh_expires_in":0,"token_type":"Bearer","not-before-policy":0,"scope":"email profile"}
----
...
[source,bash]
----
pulsar@pulsar-bastion-85c9b777f6-gt9ct:/pulsar$ bin/pulsar-admin --auth-params "token:e...CE2ug" \
      tenants list
"public"
"pulsar"
----
